...
import com.munzenberger.feed.log.*;
import com.munzenberger.feed.parser.rss.*;
...
public class MockItemHandler implements ItemHandler {
	...
	public void setFoo(String name1) {
		this.name1 = name1;
	}

	public void setBar(String name2) {
		this.name2 = name2;
	}

	public void assertValues(String value1, String value2) {
		assertEquals(value1, this.name1);
		assertEquals(value2, this.name2);
	}
